...
{
	import com.pw282.swf.tags.actions.*;
	import com.pw282.swf.tags.binary.*;
	import com.pw282.swf.tags.bitmaps.*;
	import com.pw282.swf.tags.buttons.*;
	import com.pw282.swf.tags.control.*;
	import com.pw282.swf.tags.displaylist.*;
	import com.pw282.swf.tags.font.*;
	import com.pw282.swf.tags.shapemorphing.*;
	import com.pw282.swf.tags.shapes.*;
	import com.pw282.swf.tags.sounds.*;
	import com.pw282.swf.tags.sprite.*;
	import com.pw282.swf.tags.text.*;
	import com.pw282.swf.tags.video.*;
	...
	public class TagTypes
	{
		...
		private static const TAG_CLASS:Array = [EndTag,ShowFrameTag,DefineShapeTag,null,           PlaceObjectTag,RemoveObjectTag,DefineBitsTag,DefineButtonTag,JPEGTablesTag,SetBackgroundColorTag,DefineFontTag,DefineTextTag,DoActionTag,DefineFontInfoTag,DefineSoundTag,StartSoundTag,null,       DefineButtonSoundTag,SoundStreamHeadTag,SoundStreamBlockTag,DefineBitsLosslessTag,DefineBitsJPEG2Tag,DefineShape2Tag,DefineButtonCxformTag,ProtectTag,null                 ,PlaceObject2Tag,null,RemoveObject2Tag,null      ,null,null     ,DefineShape3Tag,DefineText2Tag,DefineButton2Tag,DefineBitsJPEG3Tag,DefineBitsLossless2Tag,DefineEditTextTag,null         ,DefineSpriteTag,null            ,null         ,null               ,FrameLabelTag,null            ,SoundStreamHead2Tag,DefineMorphShapeTag,null       ,DefineFont2Tag,null        ,null               ,null          ,null      ,null            ,null            ,null          ,ExportAssetsTag,ImportAssetsTag,EnableDebuggerTag,DoInitActionTag,DefineVideoStreamTag,VideoFrameTag,DefineFontInfo2Tag,null     ,EnableDebugger2Tag,ScriptLimitsTag,SetTabIndexTag,null,null,FileAttributesTag,PlaceObject3Tag,ImportAssets2Tag,null   ,DefineFontAlignZonesTag,CSMTextSettingsTag,DefineFont3Tag,SymbolClassTag,MetadataTag,DefineScalingGridTag,null,null,null,DoABCTag,DefineShape4Tag,DefineMorphShape2Tag,null,DefineSceneAndFrameLabelDataTag,DefineBinaryDataTag,DefineFontNameTag,StartSound2Tag,DefineBitsJPEG4Tag,DefineFont4Tag];
